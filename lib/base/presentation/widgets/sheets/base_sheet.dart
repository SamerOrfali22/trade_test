...
class BaseSheet<T> extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      margin: EdgeInsets.only(top: Resources.router.navigatorKey.currentContext!.mediaQuery.padding.top),
      decoration: BoxDecoration(
        color: backgroundColor ?? context.colors.surface,
        borderRadius: BorderRadius.vertical(top: Radius.circular(16.0.r)),
      ),
      padding: EdgeInsets.only(left: 16.0.w, right: 16.0.w, bottom: context.viewInsets.bottom + 44.0.h),
      child: Column(
