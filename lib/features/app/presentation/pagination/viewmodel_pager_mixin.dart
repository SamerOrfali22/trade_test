...
import 'package:weather_app/features/app/presentation/pagination/stream_pager.dart';
...
mixin ViewmodelPagerMixin<T> on BaseViewmodel implements Pager<T> {
  ...
  Stream<Result<PaginationModel<T>>> onPageData(int pageKey);
  ...
  @override
  int get invisibleItemsThreshold => 4;
